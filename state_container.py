...
class StateContainer(object):
    ...
    @classmethod
    def log_action(cls, action: dict, path: str):
    ...
    def add_states(self, content: list, allow_reset: bool = False):
        assert all(
        ...
        self.log_action(
            action, os.path.join(self._log_dir, str(datetime.datetime.now())))
